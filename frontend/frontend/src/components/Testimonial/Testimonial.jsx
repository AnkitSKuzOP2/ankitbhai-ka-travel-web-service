  ...
  return (
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        <p>
          I am a web developer and freelancer focused on travel projects. I
          build performant, responsive sites and reliable booking flows for
          users. My work combines frontend UX with backend APIs to deliver
